<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright">
            ...
            <a href="https://creative-tim.com" target="_blank">{{ __('Pushpamal Gunasena') }}</a> &amp;
            <a href="https://updivision.com" target="_blank">{{ __('Sandaru Rangana') }}</a> {{ __('for a better network') }}.
        </div>
    </div>
</footer>
